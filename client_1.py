...
def write_cmd(sock):
    ...
    if (cmd_str[1:5]!='STAT')&(cmd_str[1:5]!='ENTI'):
        ...
        return
    sock.sendall(bytes((cmd_str+'endtweet').encode("utf8")))
    l = cmd_str.split('][')
...
def write_result(data):
    ...
    print('Done: now you can see result in RESULT.csv')

def handler(sock, buf):
